...
// ---------- 勢力一覧 ----------
export function nationsDialog(app, initTab = 'mine') {
  const st = app.st, nid = st.playerNation;
  return modal({
    title: '勢力',
    width: '820px',
...
export function helpDialog() {
  return modal({
    ...
    body: `<div class="help">
      ...
      <h3>水軍・覇業</h3>
      <ul><li>港のある都市では「水軍・造船」で軍船を造れます。海を渡って敵地へ攻めると、同じ海にいる敵の水軍が迎え撃ち、敗れると兵を失って引き返します。最も強い水軍を持つ国は制海権を握り、戦争相手の港を封鎖します（金の収入-25%・海路の交易停止）。夏と秋の日本近海では大風（神風）が船団を襲うことがあります。</li>
      <li>勝利条件は始めるときに選べます：天下統一（75%の支配）／覇王（8地域のうち4つを平定）／時代の覇者（50年後に国力第1位）。上部の「覇業」で進み具合・称号・地域の平定・国力の推移グラフを確かめられます。</li>
      <li>国が大きくなれば即位して称号（ハン→大ハーン、王→皇帝など）を名乗れます。家臣の忠誠と名声が上がります。</li></ul>
      <h3>信仰と災害</h3>
      ...
      <h3>宮廷</h3>
      <ul><li>妃には個性（賢妃・良妻・才媛・武門の娘・野心家・嫉妬深い・温順）があり、子の能力や後宮の出来事に影響します。正室の子が嫡子です。</li>
      <li>「王族」で後継ぎを指名し、幼い子に傅役と教育方針をつけ、成人した王族に封地を与えられます。嫡子をさしおいた指名や野心家の王子は、代替わりの跡目争いの火種になります。</li>
      <li>婚姻同盟を破ると信用を大きく失います。跡継ぎの絶えた国は、姫の嫁ぎ先が継ぐことがあります。</li>
      <li>妃は、他国との縁談のほか、国内の名家から、家臣の娘（家臣は外戚として忠誠が上がる）、滅びた国の妃や姫からも迎えられます。</li></ul>
      <h3>交易の拡張</h3>
      <ul><li>同じ都市で売り続けると値崩れします。輸入品には種類ごとの効果（馬・武具・食料・書物・贅沢品）があり、特産品は献上品として外交に使えます。</li>
      <li>交易の要衝を押さえると通過税が入り、港どうしは海路で結べます。交易路には護衛をつけられ、オルトクへの出資や禁輸もできます。</li></ul>
      <h3>技術者と研究</h3>
      <ul><li>技術者は毎年腕を上げ（最大Lv5）、個性（名人・師匠・発明家・強欲）を持つ者もいます。太守の政治力や特技との相性で効果が上がり、他国の技術者を引き抜くこともできます。</li>
      <li>上部の「研究」で国の技術（紙幣・火薬・羅針盤・駅伝制など）を選び、技術者の知恵で獲得します。征服や交易で技術を学び取ることもあります。</li></ul>
      <h3>技術者</h3>
